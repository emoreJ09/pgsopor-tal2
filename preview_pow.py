...
class PreviewPowModule(tk.Frame):
    ...
    def open_edit_pow_modal(self):
        ...
        edit_tree.heading("orig_desc", text="ORIGINAL NAME")
        ...
        edit_tree.column("orig_desc", width=0, stretch=tk.NO) 
        ...
        def save_all_updates_to_db():
            ...
            # REVISED SQL SYNC PIPELINE (Delete-and-Insert Pattern para iwas kalat sa sub-tables)
